...
**تحديث هيكلي هام:** بناءً على المراجعة الأخيرة، تم إكمال عملية التنظيف بشكل كامل. تم حذف جميع الملفات والمجلدات القديمة وغير المستخدمة (`src/services`, `src/types`, والملفات الفارغة الأخرى) بشكل نهائي. الآن، يعتمد المشروع **بشكل حصري** على البنية القائمة على الأنظمة والموثقة في `GAME_RULES.md`. كل الكود الفعال موجود بالكامل داخل مجلدي `src/systems` و `src/shared`.
