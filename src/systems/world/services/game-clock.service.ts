...
const SEASON_WEATHER_PROBABILITY: Record<Season, Record<Weather, number>> = {
    Spring: { Sunny: 0.4, Cloudy: 0.25, Rainy: 0.25, Stormy: 0.05, Windy: 0.05, Snowy: 0 },
    Summer: { Sunny: 0.6, Cloudy: 0.15, Rainy: 0.1, Stormy: 0.1, Windy: 0.05, Snowy: 0 },
    Autumn: { Sunny: 0.3, Cloudy: 0.3, Rainy: 0.2, Windy: 0.1, Stormy: 0.1, Snowy: 0 },
    Winter: { Sunny: 0.2, Cloudy: 0.3, Rainy: 0.1, Snowy: 0.25, Windy: 0.1, Stormy: 0.05 },
};
